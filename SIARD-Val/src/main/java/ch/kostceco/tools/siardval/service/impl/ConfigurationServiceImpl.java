...
// Holt sich das Configuration-file.
    private XMLConfiguration getConfig(){
        if (this.config == null) {
            try {
                ...
                // Im gleichen Verzeichnis wie das ".jar"-File muss sich ein Ordner namens "configuration" befinden.
                LOGGER.logError(getTextResourceService().getText(MESSAGE_CONFIGURATION_ERROR_3));
                // Im configuration-Ordner wiederum muss die Konfigurationsdatei "SIARDVal.conf.xml" liegen.
                System.exit(0);
            }
        }
        return config;
    ...
    public String getPathToWorkDir() {
         ...
         * Dieses Verzeichnis wird zum Entpacken des .zip-Files verwendet.
